...
<div id="videoContainer">
	<video bind:this={myVideo} src={srcVideo} height="288px" width="512px" muted loop controls>
		<track src={srcTtml} kind="subtitles" label="Expanded TTML Sample" srclang="en" />
	</video>
</div>
